sap.ui.define([
	...
	return BaseObject.extend("com.venky.ZMD.model.GroupSortState", {
		 ...
		 * @alias com.venky.ZMD.model.GroupSortState
		 */
		...
		/**
		 * Sorts by ProductID, or by Price
		 *
		...
		group: function (sKey) {
			...
			if (sKey === "Price") {
				...
				this._oViewModel.setProperty("/sortBy", "ProductID");
			}

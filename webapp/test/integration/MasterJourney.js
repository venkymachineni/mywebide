...
sap.ui.define([
	...
	opaTest("MasterList Filtering on Price less than 100", function(Given, When, Then) {

		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog("<Price>").
			and.iSelectListItemInViewSettingsDialog("<100 <CurrencyCode>").
	...
	opaTest("MasterList Filtering on Price more than 100", function(Given, When, Then) {
		// Action
		When.onTheMasterPage.iOpenViewSettingsDialog().
			and.iSelectListItemInViewSettingsDialog(">100 <CurrencyCode>").
			and.iPressOKInViewSelectionDialog();

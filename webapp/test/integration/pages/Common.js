sap.ui.define([
	...
	function getFrameUrl (sHash, sUrlParameters) {
		var sUrl = jQuery.sap.getResourcePath("com/venky/ZMD/app", ".html");
		sHash = sHash || "";
	...
	return Opa5.extend("com.venky.ZMD.test.integration.pages.Common", {
		...
		getMockServer : function () {
			return new Promise(function (success) {
				Opa5.getWindow().sap.ui.require(["com/venky/ZMD/localService/mockserver"], function (mockserver) {
